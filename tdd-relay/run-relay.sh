...
usage() {
	...
	{
		echo "${script_name} - Runs a TDD relay container."
...
container_name='tdd-relay'
docker_args=''
docker_tag='tdd-relay:4-amd64'
#docker_tag='glevand/tdd-relay:latest'
as_root=''
usage=''
verbose=''
debug=''

user_cmd='/usr/bin/tdd-relay --verbose --port=9600'
...
docker_extra_args='--publish 9600:9600/tcp --volume /etc/tdd-relay.conf:/etc/tdd-relay.conf'
